...
title("Annual PM2.5 Emissions from 1999 to 2008 in Baltimore City")
axis(1, seq(1999,2008, 3),las=1, font=1,cex.axis=0.8)

dev.copy(png, file="DataScience/exploratory_data_analysis/week4/plot2.png", height=480, width=480)
dev.off()
